...
public interface TrestleHARRepository extends JpaRepository<TrestleHAR, Long>, JpaSpecificationExecutor<TrestleHAR>
{

    TrestleHAR findByListingKeyNumeric(Integer ListingKeyNumeric);

    List<TrestleHAR> findByIdIn(List<Long> ids);

    List<TrestleHAR> findByListingKeyNumericIn(List<Integer> ListingKeyNumerics);

    List<TrestleHAR> findByStatusChangeTimestampBetween(Date startTime, Date endTime);

    List<TrestleHAR> findByPropertyTypeAndStatusChangeTimestampBetween(String propertyType, Date startTime, Date endTime);
